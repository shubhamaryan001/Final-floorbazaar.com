              ...
              <div className="track-block">
                {order.cancelled ? (
                    ...
                    <div className="card m-2">
                      ...
                      <div className="p-2 text-left">
                        <p className="mb-0">
                          ...
                          3-5 working days. Till that time if you have any query
                          you can chat on our chat support.
                        </p>
                      </div>
                    </div>
                  </>
                  ...
                  <>
                        ...
                        <div className="card m-2">
                          ...
                          >
                            <span>
                              ...
                              <br />
                              <p className="mb-0">
                                Our engineer will call you for the plot or land
                          ...
                          >
                            <span>
                              <p className="mb-0">
                                ...
                                other plans and documents will be provided with
                                complete project file. After paying second
                                payment automatically the file will unlock to
                                download.
                              </p>
                            </span>
                          </div>
                          ...
                          >
                            <span>
                              <p className="mb-0">
                                ...
                                link is updated to latest version of your plans
                                and documents.You can go and download latest
                                files.
                              </p>
                            </span>
                          </div>
                    ...
                    <div className="container-fluid ">{ShowCancelButton()}</div>
                  </>
                )}
              </div>
            </div>
          ...
          <div className="col-xl-4 col-md-4 col-sm-12 mb-4">
            <div className="project-file">
              <div className="card" style={{ background: "#ebe6e6" }}>
                ...
                >
                  <FaFileAlt className="header-logo" /> Project Files And
                  Documents
                </h5>
              ...
              <div className="card" style={{ background: "#FFF" }}>
                ...
                <div className="details-block p-3">
                  ...
                  <div className="row">
                    ...
                    <div className="col-6">
                      <p className="text-muted">{order.assignedName}</p>
                    </div>
                  </div>
